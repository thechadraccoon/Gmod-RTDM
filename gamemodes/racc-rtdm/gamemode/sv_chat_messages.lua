hook.Add("PlayerSay", "tdm_say", function(ply, text, bTeam)
    local howweapons = {"how do i switch weapons", "switch weapons", "change weapons", "change weapon", "switch weapon", "change loadout", "switch loadout", "different weapons"}

    local howteams = {"how do i switch teams", "switch teams", "change team"}

    local racc = {"racc can you", "racc can i", "racc may i", "racc is it okay if", "racc is it okay", "racc pls", "racc plz", "racc could you", "racc please", "racc i need", "racc help me", "racc would you", "racc will you",}
